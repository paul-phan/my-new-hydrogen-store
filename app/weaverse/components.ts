...
import * as CollapsibleContent from "~/sections/collapsible-content";
import * as CollapsibleContentItems from "~/sections/collapsible-content/items";
import * as CollapsibleContentItem from "~/sections/collapsible-content/item";
